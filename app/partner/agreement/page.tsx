              ...
              <table className="w-full text-sm border border-white/10 print:border-gray-300 rounded-lg overflow-hidden mb-4">
                ...
                <tbody className="divide-y divide-white/10 print:divide-gray-200">
                  <tr>
                    ...
                    <td className="px-4 py-2">€49/mo</td>
                    <td className="px-4 py-2">€490/yr</td>
                  ...
                  <tr>
                    ...
                    <td className="px-4 py-2">€149/mo</td>
                    <td className="px-4 py-2">€1,490/yr</td>
                    <td className="px-4 py-2 font-semibold text-green-400 print:text-green-700">20% of first 12 months</td>
                  </tr>
                  <tr>
                    <td className="px-4 py-2">Enterprise</td>
                    <td className="px-4 py-2">€299/mo</td>
                    <td className="px-4 py-2">€2,999/yr</td>
                    <td className="px-4 py-2 font-semibold text-green-400 print:text-green-700">20% of first 12 months</td>
                  </tr>
                </tbody>
              </table>
