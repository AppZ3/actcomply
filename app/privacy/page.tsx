        ...
        <div className="prose prose-invert prose-sm max-w-none space-y-8 text-gray-300 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 ml-4">
              <li><strong className="text-white">Account data:</strong> Email address, name (when provided)</li>
              <li><strong className="text-white">Payment data:</strong> Billing details processed by Stripe — we do not store card numbers</li>
              <li><strong className="text-white">Assessment data:</strong> Descriptions of AI systems you submit for compliance analysis</li>
              <li><strong className="text-white">Usage data:</strong> Pages visited, features used, timestamps — collected via cookies</li>
              <li><strong className="text-white">Communications:</strong> Support emails and messages you send us</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mt-2 ml-4">
              ...
              <li><strong className="text-white">Legitimate interests:</strong> Analytics, security, fraud prevention</li>
              <li><strong className="text-white">Legal obligation:</strong> Retaining transaction records as required by law</li>
              <li><strong className="text-white">Consent:</strong> Non-essential cookies (you may withdraw consent at any time)</li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mt-2 ml-4">
              ...
              <li><strong className="text-white">Anthropic</strong> — AI processing of your assessment submissions (no data used for training)</li>
              <li><strong className="text-white">Vercel</strong> — platform hosting</li>
            </ul>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mt-2 ml-4">
              ...
              <li><strong className="text-white">Restriction</strong> — request we limit processing in certain circumstances</li>
            </ul>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2 mt-2 ml-4">
              <li><strong className="text-white">Essential:</strong> Authentication session cookies — required for the Service to function</li>
              <li><strong className="text-white">Functional:</strong> Preferences and settings (consent to this category via our cookie banner)</li>
            </ul>
